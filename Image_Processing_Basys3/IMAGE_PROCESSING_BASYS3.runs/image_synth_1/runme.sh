...
HD_PWD='D:/college studies/sem 6/HDL/CH11_IMAGE_PROCESSING_VGA/CH11_IMAGE_PROCESSING_VGA/IMAGE_PROCESSING_BASYS3/IMAGE_PROCESSING_BASYS3.runs/image_synth_1'
cd "$HD_PWD"
