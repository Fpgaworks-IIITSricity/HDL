...
#
# Script generated by Vivado on Fri May 09 11:05:20 +0530 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : vga_syncIndex.sh
...
#
# Usage        : vga_syncIndex.sh
#                vga_syncIndex.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vga_syncIndex.sh [-reset_run]
#                vga_syncIndex.sh [-reset_log]
#                vga_syncIndex.sh [-help]
#
...
# script info
echo -e "vga_syncIndex.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vga_syncIndex.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_9 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot vga_syncIndex xil_defaultlib.vga_syncIndex xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vga_syncIndex -key {Behavioral:sim_1:Functional:vga_syncIndex} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb vga_syncIndex.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vga_syncIndex.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vga_syncIndex.sh [-help]\n\
Usage: vga_syncIndex.sh [-step]\n\
Usage: vga_syncIndex.sh [-lib_map_path]\n\
Usage: vga_syncIndex.sh [-reset_run]\n\
Usage: vga_syncIndex.sh [-reset_log]\n\
Usage: vga_syncIndex.sh [-keep_index]\n\
Usage: vga_syncIndex.sh [-noclean_files]\n\n\
