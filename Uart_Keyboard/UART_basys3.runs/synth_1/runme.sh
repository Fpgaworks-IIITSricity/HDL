...
HD_PWD='C:/Users/lucia/UART_basys3/UART_basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Receiver_RxD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Receiver_RxD.tcl
