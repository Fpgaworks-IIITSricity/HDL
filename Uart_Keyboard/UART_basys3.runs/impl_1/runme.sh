...
HD_PWD='C:/Users/lucia/UART_basys3/UART_basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Receiver_RxD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Receiver_RxD.tcl -notrace
