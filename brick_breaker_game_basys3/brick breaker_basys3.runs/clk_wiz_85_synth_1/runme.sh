...
HD_PWD='C:/Users/hemanth kumar/brick breaker_basys3/brick breaker_basys3.runs/clk_wiz_85_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_85.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_85.tcl
