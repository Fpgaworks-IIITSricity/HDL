...
HD_PWD='C:/Users/ashbo/Desktop/Vivado/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_compare.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_compare.tcl
