...
HD_PWD='C:/Users/ashbo/Desktop/Vivado/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_compare.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_compare.tcl -notrace
