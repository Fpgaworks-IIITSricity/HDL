...
HD_PWD='C:/Users/ashiv/Downloads/project_3/project_3.runs/synth_1_copy_2'
cd "$HD_PWD"
...
EAStep vivado -log temp_monitor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_monitor.tcl
