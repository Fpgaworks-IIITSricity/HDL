...
HD_PWD='C:/Users/ashiv/Downloads/project_3/project_3.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log temp_monitor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_monitor.tcl -notrace
